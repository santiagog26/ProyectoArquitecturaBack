...
try:
  ...
  if err.errno == errorcode.ER_ACCESS_DENIED_ERROR:
    ...
    print('    <link rel="stylesheet" href="/var/www/html/ProyectoArquitectura/css/icon/css/fontello.css">')
    print('    <link rel="stylesheet" href="/var/www/html/ProyectoArquitectura/css/menu.css">')
    print('    <link rel="stylesheet" href="/var/www/html/ProyectoArquitectura/css/registro.css">')
    print('    <link rel="stylesheet" href="/var/www/html/ProyectoArquitectura/css/tabla.css">')
